...
export const WeightIcon: React.FC<WeightIconProps> = props => {
  ...
  const opacity = props.isGood ? 0.38 : 1;
  const svgSource = `
    <svg viewBox="0 0 520 520" width="100" height="100">
      <g>
        ...
        <text x="50" y="350" opacity="${opacity}" font-size="160">${props.weightLatest.toFixed(
    1
  )}</text>
        <text x="370" y="350" opacity="${opacity}" font-size="80">kg</text>

        <text x="60" y="450" opacity="${opacity}" font-size="80">
          ${props.deltaWeekly.toFixed(1)}
        </text>
        <text x="200" y="450" opacity="${opacity}" font-size="40">
          kg
        </text>

        <text x="285" y="450" opacity="${opacity}" font-size="80">
          ${props.deltaWPercent.toFixed(1)}
        </text>
        <text x="430" y="450" opacity="${opacity}" font-size="40">
          %
        </text>
      </g>
    </svg>
